...
export const metadata: Metadata = {
    ...
    description:
        "Доставка свежей пиццы и напитков на дом — быстро, вкусно, горячим! Заказывайте онлайн 24/7. Широкий выбор начинок, хрустящее тесто. Оплата картой или наличными.",
    openGraph: {
        type: "website",
        title: "Next Pizza | Главная",
        description:
